...
from harmonicdogp import do_gp
import pandas as pd
...
config = [
    dict(species="dog",
     ...
     labels = ['95% credible interval', '99% credible interval'],
    ),
    dict(species="dog",
     mpc="pruritus",
     location = None,
    ...
    dict(species="dog",
     ...
     labels = ['90% credible interval', '95% credible interval'],
    ),
    dict(species="dog",
     mpc="gastroenteric",
    ...
    dict(species="dog",
     mpc="respiratory",
     location="South West (England)",
     plot_filename="dog_respiratory_southwest",
    ...
    dict(species="cat",
     mpc="respiratory",
     location="South West (England)",
     plot_filename="cat_respiratory_southwest",
...
if __name__ == "__main__":
    """Drives production of Harmonic GP timeseries analyses.
